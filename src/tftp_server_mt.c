...
void show_help_mt(void) {
    printf("\n");
    printf("=================================================================\n");
    printf("                    多线程TFTP服务器 v1.0                        \n");
    printf("=================================================================\n");
    printf("功能特性:\n");
    printf("  ✓ 支持多客户端并发访问\n");
    printf("  ✓ 支持文件上传(PUT)和下载(GET)\n");
    printf("  ✓ 支持netascii和octet传输模式\n");
    printf("  ✓ 自动重传和错误恢复\n");
    printf("  ✓ 线程安全的日志记录\n");
    printf("  ✓ 传输速度统计\n");
    printf("\n");
    printf("服务器配置:\n");
    printf("  监听端口: %d\n", TFTP_PORT);
    printf("  文件根目录: tftp_root/\n");
    printf("  日志文件: logs/tftp_server_mt.log\n");
    printf("  最大重试次数: %d\n", MAX_RETRIES);
    printf("  超时时间: %d秒\n", TIMEOUT_SECONDS);
    printf("\n");
    printf("客户端使用示例:\n");
    printf("  下载文件: tftp -i 127.0.0.1 get test.txt local_test.txt\n");
    printf("  上传文件: tftp -i 127.0.0.1 put local_file.txt remote_file.txt\n");
    printf("\n");
